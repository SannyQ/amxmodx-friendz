...
public plugin_init()
{
	...
	register_concmd("csdm_ffas_menu", "csdm_ffas_menu", ACCESS, "CSDM FFA Settings Menu")
	...
	if (g_MainPlugin)
	{
		...
		menu_additem(g_SettingsMenu, "CSDM FFA Settings", "csdm_ffas_menu", ACCESS)
...
public csdm_ffas_menu(id, level, cid)
{
