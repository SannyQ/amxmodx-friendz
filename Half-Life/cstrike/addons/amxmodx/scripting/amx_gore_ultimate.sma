...
****************************************************************************
*
*   Version 1.6.1 - September 20, 2017
*
...
#include <amxmodx>
#include <amxmisc>
#include <engine> // for get_decal_index() -R4to0
#include <fakemeta>
#include <dodconst>
#include <tfcconst>
#include <tsconst>
...
public plugin_init()
{
	register_plugin("Ultimate Gore","1.6.1","JTP10181")
	...
	new const decalnames_small[BLOOD_SM_NUM][] = {
		"{BLOOD1",
		"{BLOOD2",
		"{BLOOD3",
		"{BLOOD4",
	...
	for (new r=0; r<BLOOD_LG_NUM; r++) {
		blood_large_red[r] = get_decal_index(decalnames_large[r])
	}

	for (new t=0; t<BLOOD_SM_NUM; t++) {
