...
public plugin_init()
{
	...
	register_concmd("csdm_tickets_menu", "csdm_tickets_menu", ADMIN_MAP, "CSDM Tickets Settings Menu")
	...
	if (main_plugin)
	{
		...
		menu_additem(g_SettingsMenu, "CSDM Tickets Settings", "csdm_tickets_menu", ADMIN_MAP)
...
public csdm_tickets_menu(id, level, cid)
{
