...
//	g_msgAmmoPickup = get_user_msgid("AmmoPickup")
	...
	register_concmd("csdm_miscs_menu", "csdm_miscs_menu", ADMIN_MAP, "CSDM Misc Settings Menu")
	...
	if (main_plugin)
	{
		...
		menu_additem(g_SettingsMenu, "CSDM Misc Settings", "csdm_miscs_menu", ADMIN_MAP)
...
public csdm_miscs_menu(id, level, cid)
{
