 ...
 *
 * (C)2003-2014 Borja "FALUCO" Ferrer
 * (C)2003-2014 KWo
...
public plugin_init()
{
	...
	register_concmd("edit_items", "show_i_menu", ADMIN_MAP, "Edits Items configuration")
	...
	register_concmd("csdm_is_menu", "csdm_is_menu", ADMIN_MAP, "CSDM Item Settings Menu")
	...
	if (g_MainPlugin)
	{
		...
		menu_additem(g_SettingsMenu, "CSDM Item Settings", "csdm_is_menu", ADMIN_MAP)
...
public csdm_is_menu(id, level, cid)
{
...
public show_i_menu(id, level, cid)
{
	if (!cmd_access(id, level, cid, 1) || !id)
		return PLUGIN_HANDLED
